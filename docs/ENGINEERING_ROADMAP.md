...
| **Engine** | K8s 部署 vLLM。Llama 3.1 8B AWQ INT4 跑通首个 `/v1/chat/completions`。模型权重存储在 S3/MinIO | 003, 006 |
...
| **Engine** | Fork vLLM。招聘 2 名 GPU/CUDA 工程师。定义 rebase cadence（每 2 周） | 003, 009 |
